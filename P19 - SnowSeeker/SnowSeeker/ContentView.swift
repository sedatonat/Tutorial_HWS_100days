...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            WelcomeView()  // Here SwiftUI understands that if the layout is LS show it if not don't. Thus it is only visible in LandScape Mode. But how it knows that? #learn
        }
